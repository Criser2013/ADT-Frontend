 ...
 * @param {String|Number} altura Altura de la tarjeta.
 * @returns {JSX.Element}
 */
export default function TarjetaMenuPrincipal({
    titulo, valor, icono, colorFondo = "#cce4f2",
    colorTexto = "#182d6d", colorFondoIcono = "#aeccea", altura = "80%"
}) {
    const { tema } = useTema();
