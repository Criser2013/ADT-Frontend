...
describe("Validar la funcion 'peticionApi'", () => {
    ...
    const res2 = { success: false, error: "Acceso no autorizado", data: null };
    const res3 = { success: false, data: null, error: "Ha ocurrido un error al generar el diagnóstico. Por favor reintenta nuevamente." };
